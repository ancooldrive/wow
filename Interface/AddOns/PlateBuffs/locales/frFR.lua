...
L["Only show spells above nameplates that are in combat."] = "Montrer les sorts seulement sur les nameplates qui sont en combat" -- Needs review
L["Other"] = "Autre"
...
L["Row Growth"] = "Direction de la ligne" -- Needs review
L["Rows"] = "Lignes"
...
L["Show"] = "Montrer"
L["Show a clock overlay over spell textures showing the time remaining."] = "Montrer le temps restant par dessus les textures des sorts" -- Needs review
...
L["Show spell icons on totems"] = "Montrer les icônes des totems" -- Needs review
...
L["Watch Combatlog"] = "Suivre le log de combat" -- Needs review

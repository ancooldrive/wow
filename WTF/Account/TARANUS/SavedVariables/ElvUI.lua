...
ElvDB = {
	["profileKeys"] = {
		["Boolcathos - Icecrown"] = "Dredlord - Icecrown",
	...
	["profiles"] = {
		["Boolcathos - Icecrown"] = {
			...
			["movers"] = {
				...
				["ShiftAB"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,3,1298",
				["ElvUF_PartyMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,3,195",
				["ElvUF_RaidMover"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,3,428",
		...
		["Dredlord - Icecrown"] = {
			...
			["movers"] = {
				...
				["ElvUF_RaidMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,3,394",
				...
				["ElvAB_4"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-475,3",
				["AlertFrameMover"] = "TOP,ElvUIParent,TOP,-1,-18",
				["ElvUF_PartyMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,3,247",
				["ElvAB_3"] = "BOTTOM,ElvUIParent,BOTTOM,0,33",
				["LootFrameMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,250,-104",
				["ElvUIBagMover"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-3,29",
				...
				["ElvUF_RaidpetMover"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,3,737",
				["ShiftAB"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,3,273",
				["ElvUF_TargetCastbarMover"] = "TOP,ElvUIParent,TOP,0,-631",
				["ElvUF_FocusMover"] = "BOTTOM,ElvUIParent,BOTTOM,342,59",
				["ElvAB_6"] = "BOTTOM,ElvUIParent,BOTTOM,-176,560",
				...
				["ElvAB_5"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,482,3",
		...
		["Npw - Icecrown"] = {
			...
			["movers"] = {
				["ElvBar_Pet"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-85,-446",
				["ElvUF_RaidpetMover"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,3,737",
				["ShiftAB"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,3,1298",
				["LeftChatMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,3,3",
				["ElvUF_RaidMover"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,3,428",
				["ElvAB_6"] = "BOTTOM,ElvUIParent,BOTTOM,174,231",
				["ElvUF_TargetCastbarMover"] = "TOP,ElvUIParent,TOP,0,-643",
				["ArenaHeaderMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-125,-446",
				["BossHeaderMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-125,-446",
				["ElvAB_3"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-426,3",
				["ElvAB_2"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,426,3",
				["ElvUF_PartyMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,3,195",
				["ElvAB_5"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-44,-444",
				["ElvAB_1"] = "BOTTOM,ElvUIParent,BOTTOM,0,3",
				["ElvUF_Raid40Mover"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,3,433",
			},
			["hideTutorial"] = 1,
